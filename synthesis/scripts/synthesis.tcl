...
set DESIGN "elevator_fsm"

# analyze design
analyze -format verilog { ../../source/elevator_fsm.v }
analyze -format verilog { ../../source/elevator_button.v }

# elaborate design
elaborate elevator_fsm -architecture verilog -library DEFAULT
uniquify
